...
\begin{DoxyCompactList}\small\item\em Returns the frequencies of different on chip clocks; SYSCLK, HCLK, PCLK1 and PCLK2. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\Hypertarget{group___r_c_c___group2_doc-func-members}
\doxysubsubsubsubsection{Function Documentation}
\Hypertarget{group___r_c_c___group2_ga3e9944fd1ed734275222bbb3e3f29993}\index{System AHB and APB busses clocks configuration functions@{System AHB and APB busses clocks configuration functions}!RCC\_GetClocksFreq@{RCC\_GetClocksFreq}}
...
{\footnotesize\ttfamily \label{group___r_c_c___group2_ga3e9944fd1ed734275222bbb3e3f29993} 
void RCC\+\_\+\+Get\+Clocks\+Freq (\begin{DoxyParamCaption}\item[{RCC\+\_\+\+Clocks\+Type\+Def \texorpdfstring{$\ast$}{*}}]{RCC\+\_\+\+Clocks}{}\end{DoxyParamCaption})}
...
If SYSCLK source is HSI, function returns values based on HSI\+\_\+\+VALUE(\texorpdfstring{$\ast$}{*}) 

If SYSCLK source is HSE, function returns values based on HSE\+\_\+\+VALUE(\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}) 

If SYSCLK source is PLL, function returns values based on HSE\+\_\+\+VALUE(\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}) or HSI\+\_\+\+VALUE(\texorpdfstring{$\ast$}{*}) multiplied/\+divided by the PLL factors. ~\newline
...
{\em RCC\+\_\+\+Clocks} & pointer to a RCC\+\_\+\+Clocks\+Type\+Def structure which will hold the clocks frequencies.\\
\hline
\end{DoxyParams}
\begin{DoxyNote}{Note}
...
\hline
\end{DoxyRetVals}
\Hypertarget{group___r_c_c___group2_gaaeb32311c208b2a980841c9c884a41ea}\index{System AHB and APB busses clocks configuration functions@{System AHB and APB busses clocks configuration functions}!RCC\_GetSYSCLKSource@{RCC\_GetSYSCLKSource}}
...
{\footnotesize\ttfamily \label{group___r_c_c___group2_gaaeb32311c208b2a980841c9c884a41ea} 
...
\hline
\end{DoxyRetVals}
\Hypertarget{group___r_c_c___group2_ga9d0aec72e236c6cdf3a3a82dfb525491}\index{System AHB and APB busses clocks configuration functions@{System AHB and APB busses clocks configuration functions}!RCC\_HCLKConfig@{RCC\_HCLKConfig}}
...
{\footnotesize\ttfamily \label{group___r_c_c___group2_ga9d0aec72e236c6cdf3a3a82dfb525491} 
...
\hline
\end{DoxyRetVals}
\Hypertarget{group___r_c_c___group2_ga448137346d4292985d4e7a61dd1a824f}\index{System AHB and APB busses clocks configuration functions@{System AHB and APB busses clocks configuration functions}!RCC\_PCLK1Config@{RCC\_PCLK1Config}}
...
{\footnotesize\ttfamily \label{group___r_c_c___group2_ga448137346d4292985d4e7a61dd1a824f} 
...
\hline
\end{DoxyRetVals}
\Hypertarget{group___r_c_c___group2_ga09f9c010a4adca9e036da42c2ca6126a}\index{System AHB and APB busses clocks configuration functions@{System AHB and APB busses clocks configuration functions}!RCC\_PCLK2Config@{RCC\_PCLK2Config}}
...
{\footnotesize\ttfamily \label{group___r_c_c___group2_ga09f9c010a4adca9e036da42c2ca6126a} 
...
\hline
\end{DoxyRetVals}
\Hypertarget{group___r_c_c___group2_ga3551a36a8f0a3dc96a74d6b939048337}\index{System AHB and APB busses clocks configuration functions@{System AHB and APB busses clocks configuration functions}!RCC\_SYSCLKConfig@{RCC\_SYSCLKConfig}}
...
{\footnotesize\ttfamily \label{group___r_c_c___group2_ga3551a36a8f0a3dc96a74d6b939048337} 
